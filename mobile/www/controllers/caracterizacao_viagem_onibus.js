	...
	validar_componentes : function(id_avancar) {
		...
		if(util.validaSelect("origem_pais_onibus", "Origem da viagem") &&
			...
			if((Number($("#origem_pais_onibus").val())) == 1) { // Brasil
				ok_origem_bra = (util.validaSelect("origem_uf_onibus", "Origem da viagem - estado") &&
						  util.validaSelect("origem_municipio_onibus", "Origem da viagem - município"));
			}
			
			var ok_destino_bra = true; 
			if((Number($("#destino_pais_onibus").val())) == 1) { // Brasil
				ok_destino_bra = (util.validaSelect("destino_uf_onibus", "Destino da viagem - estado") &&
						  util.validaSelect("destino_municipio_onibus", "Destino da viagem - município"));
			}
