...
//		});
		...
		util.progressoRadioSimNaoAlternado("sabe_embarque", "sabe_embarque_carga", "div_sabe_embarque_sim", "grupo_sabe_desembarque_carga");
		...
		util.progressoRadioSimNaoAlternado("sabe_desembarque", "sabe_desembarque_carga", "div_sabe_desembarque_sim", /*TODO verificar se eh carga especial*/"grupo_parada_especial_carga");
				...
				function() {
					...
					if (estado != '-1') {
						$('#desembarque_mun_carga').off("click").click(
								function() {
									util.autocomplete("desembarque_mun_carga", lista_municipios[estado], "Município de desembarque",
											"Entre com o município de desembarque");
								}).trigger('click');
					}
				});
		util.progressoInputText("municipioDesembarqueCarga", "desembarque_mun_carga", "desembarque_local_carga", true);
		util.progressoSelect("idLocalDesembarqueCarga", "desembarque_local_carga", /*TODO verificar se eh carga especial*/"grupo_parada_especial_carga");
		//TODO Show do componente acima depende se eh carga especial. Se nao, faz show no seguinte.

		
		
		//TODO carga anterior
		util.progressoRadioSimNaoAlternado("carga_anterior", "carga_anterior_carga", "grupo_produto_anterior_carga", "grupo_indo_pegar_carga");
		$('#produto_anterior_carga').click(
				function() {
